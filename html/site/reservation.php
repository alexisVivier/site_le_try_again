...
<?php  
        ...
        $newResa = $bdd->prepare("INSERT INTO reservation(reservation_obj, reservation_txt, first_name, last_name, reservation_date, email, tel, reservation_people) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        <form action="" method="post">
            <div id="formResa">
                ...
                <div id="eventTypeInputs">
                    ...
                    <div id="eventTypeForm">
                        ...
                        <div id="typeEventOne">
                            <input type="radio" name="eventType" value="evenement d'entreprise">
            ...
            <?php 
                if(isset($_POST['envoyer'])){
                    ...
                    $reservationType = htmlspecialchars($_POST['eventType']);
                    $reservationTxt = htmlspecialchars($_POST['textResa']);
                    
                    $newResa->bindParam('1', $reservationType);
                    $newResa->bindParam('2', $reservationTxt);
                    $newResa->bindParam('3', $firstName);
                    $newResa->bindParam('4', $lastName);
                    $newResa->bindParam('5', $date);
                    $newResa->bindParam('6', $mail);
                    $newResa->bindParam('7', $phone);
                    $newResa->bindParam('8', $people);
                    $newResa->execute();
                }
